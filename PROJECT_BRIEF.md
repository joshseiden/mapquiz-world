...
- [ ] **Welcome screen v3** (spec agreed 2026-08-01 — the current single dense paragraph won't get read, and Hard mode deserves a visible entry point at the start):
